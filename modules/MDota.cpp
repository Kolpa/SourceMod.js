...
MDota::MDota(){
	...
	FIND_DOTA_PTR_NEW(GameManager, "\x83\xC4\x0C\x68\x2A\x2A\x2A\x2A\xB9\x02\x00\x00\x00\x8B\xC6\xE8\x2A\x2A\x2A\x2A\x89\x83\x2A\x2A\x00\x00\x85\xC0", 4);
	...
	FIND_DOTA_FUNC_NEW(ForceKill, "\x55\x8B\xEC\x83\xE4\xF8\x83\xEC\x58\x56\x8B\xF1\x83\xBE\xDC\x00\x00\x00\x00\x57\x8D\xBE\xDC\x00\x00\x00\x7E*\x8D\x44\x24\x08\xE8");
	FIND_DOTA_FUNC_NEW(SetControllableByPlayer, "\x55\x8B\xEC\x51\x56\x89\x86\x64\x2A\x00\x00\xE8\x2A\x2A\x2A\x2A\x80\x7D\x08\x00\x75\x2A\x83");
	FIND_DOTA_FUNC_NEW(SetPurchaser, "");
	...
	FIND_DOTA_FUNC_NEW(ChangeToRandomHero, "\x55\x8B\xEC\x83\xE4\xF8\x83\xEC\x4C\x53\x56\x8B\x75\x08\x8B\x06\x8B\x90\x2A\x2A\x00\x00\x57\x8B\xCE\xFF\xD2\x8B\x0D\x2A\x2A\x2A\x2A\x50\xE8\x2A\x2A\x2A\x2A\x89\x44\x24\x14\x8B\x86");
	...
	FIND_DOTA_FUNC_NEW(FindOrCreatePlayerID, "\x55\x8B\xEC\x83\xEC\x08\x53\x83\xCB\xFF\x80\x7D\x14\x00\x56\x8B\x75\x08\x57\x89\x5D\xF8\x89\x5D\xFC");
	FIND_DOTA_FUNC_NEW(ModifyGold, "\x55\x8B\xEC\x81\xEC\x04\x01\x00\x00\x53\x8B\x5D\x08\x56\x57\x8B\xF1\x83\xFB\x09\x76\x2A\x33\xC0\x5F\x5E\x5B\x8B\xE5\x5D\xC2\x10\x00")
